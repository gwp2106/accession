...
<div id="wrapLogin">
	...
	<!-- footer -->
		<div class="lobFooter">
			<h2><img src="/images/egovframework/bopr/mois.gif"  alt="행정안전부 로고" /><img src="/images/egovframework/bopr/img_nia_2020.png" alt="한국지능정보사회진흥원 logo" width="118" height="39"/></h2>
			<br><address>&nbsp; &nbsp;대구광역시 동구 첨단로 53 (41068).
© MINISTRY OF THE INTERIOR AND SAFETY. ALL RIGHTS RESERVED</address>
		</div>
	<!-- //footer -->
</div>
	<!-- Hidden값 -->
