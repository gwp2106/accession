...
import egovframework.com.cop.cmt.service.BoardMaster;
import egovframework.com.cop.cmt.service.BoardMasterVO;
...
public class EgovBBSCommentServiceImpl extends EgovAbstractServiceImpl implements EgovBBSCommentService {
	...
	return bbsCommentDAO.getCommentEvl(comment);
    }
	...
	public void deleteAllComments(CommentVO commentVO) throws Exception {
		bbsCommentDAO.deleteAllComments(commentVO);
	}
}
