...
public class SmsDAO extends EgovComAbstractDAO {
     ...
     * @throws Exception
     */
    public int insertSmsInf(Sms sms) throws Exception {
     ...
     * @throws Exception
     */
    public int insertSmsRecptnInf(SmsRecptn smsRecptn) throws Exception {
     ...
     * @throws Exception
     */
    public int updateSmsRecptnInf(SmsRecptn smsRecptn) throws Exception {
	return insert("SmsDAO.updateSmsRecptnInf", smsRecptn);
    }
}
