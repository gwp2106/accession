...
public class SttusNtcnDAO extends EgovComAbstractDAO {
	...
	public int selectSttusNtcnListTotCnt(SttusNtcnVO sttusNtcnVO) throws Exception {
		return (Integer) selectOne("SttusNtcnDAO.selectSttusNtcnListTotCnt", sttusNtcnVO);
	}
	...
	public SttusNtcnVO selectSttusNtcn(SttusNtcnVO sttusNtcnVO) throws Exception {
		return (SttusNtcnVO) selectOne("SttusNtcnDAO.selectSttusNtcn", sttusNtcnVO);
	}
