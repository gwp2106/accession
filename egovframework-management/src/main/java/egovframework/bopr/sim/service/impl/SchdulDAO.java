...
public class SchdulDAO extends EgovComAbstractDAO {
	...
	{
		return (Integer)selectOne("SchdulDAO.selectSchdulListTotCnt", schdulVO);
	}
	...
	{
		return (SchdulVO)selectOne("SchdulDAO.selectSchdul", schdulVO);
	}
	...
	{
		return (SchdulVO)selectOne("SchdulDAO.selectSchdulNo", schdulVO);
	}
