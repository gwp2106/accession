...
public class BatchInfoDAO extends EgovComAbstractDAO {
	...
	public int selectBatchInfoListTotcnt(BatchInfoVO batchInfoVO) throws Exception {
		return (Integer) selectOne("BatchInfoDAO.selectBatchInfoListTotCnt", batchInfoVO);
	}
	...
	public BatchInfoVO selectBatchInfo(BatchInfoVO batchInfoVO) throws Exception {
		return (BatchInfoVO) selectOne("BatchInfoDAO.selectBatchInfo", batchInfoVO);
	}
	...
	public BatchAtchFileVO selectBatchAtchFile(BatchAtchFileVO batchAtchFileVO) throws Exception {
		return (BatchAtchFileVO) selectOne("BatchInfoDAO.selectBatchAtchFile", batchAtchFileVO);
	}
