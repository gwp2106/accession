...
public class BatchWdtbDAO extends EgovComAbstractDAO {
	...
	{
		return (Integer)selectOne("BatchWdtbDAO.selectBatchWdtbListTotCnt", batchWdtbVO);
	}
	...
	{
		return (BatchWdtbVO)selectOne("BatchWdtbDAO.selectBatchWdtb", batchWdtbVO);
	...
	{
		return (BatchAtchFileVO)selectOne("BatchWdtbDAO.selectBatchWdtbAtchFile", batchAtchFileVO);
	}
