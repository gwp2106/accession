...
public class BatchExecutDAO extends EgovComAbstractDAO {
	...
	{
		return (Integer)selectOne("BatchExecutDAO.selectBatchExecuListTotCnt", batchExecutVO);
	}
	...
	{
		return (BatchExecutVO)selectOne("BatchExecutDAO.selectBatchExecut", batchexecutVO);
	}
