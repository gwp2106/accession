...
public class ExecutResultDAO extends EgovComAbstractDAO{
	 /**
	 * Job 실행결과목록을 조회한다.
	...
	public ExecutResultVO selectExecutResult(ExecutResultVO executResultVO) throws Exception{
		return (ExecutResultVO) selectOne("executResultDAO.selectExecutResult", executResultVO);
	}
	/**
	...
	public int selectExecutResultListTotCnt(ExecutResultVO executResultVO) throws Exception{
		return (Integer)selectOne("executResultDAO.selectExecutResultListTotCnt", executResultVO);
	}
	/**
	 * 모든 Job 실행결과목록을 조회한다.
	 * @param executResultVO JobHistVO
