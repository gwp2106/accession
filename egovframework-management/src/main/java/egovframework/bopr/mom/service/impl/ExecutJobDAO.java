...
public class ExecutJobDAO extends EgovComAbstractDAO{
	 /**
	 * 실행중 Job 관리목록을 조회한다.
	...
	public ExecutJobVO selectExecutJob(ExecutJobVO executJobVO) throws Exception{
		return (ExecutJobVO) selectOne("executJobDAO.selectExecutJob", executJobVO);
	}
	/**
	 * 재처리 Job 관리를 조회한다.
	 * @param ExecutJobVO egovExecutJobVO
	...
	public ExecutJobVO selectRehndnJob(ExecutJobVO executJobVO) throws Exception{
		return (ExecutJobVO) selectOne("executJobDAO.selectRehndnJob", executJobVO);
	}
	/**
	...
	public int selectExecutJobListTotCnt(ExecutJobVO executJobVO) throws Exception{
		return (Integer)selectOne("executJobDAO.selectExecutJobListTotCnt", executJobVO);
	}
	/**
	...
	public int selectRehndnJobListTotCnt(ExecutJobVO executJobVO) throws Exception{
		return (Integer)selectOne("executJobDAO.selectRehndnJobListTotCnt", executJobVO);
	}
	/**
