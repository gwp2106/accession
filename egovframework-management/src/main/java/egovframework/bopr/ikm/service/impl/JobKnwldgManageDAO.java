...
public class JobKnwldgManageDAO extends EgovComAbstractDAO {
    ...
    public int selectJobKnwldgListTotCnt(JobKnwldgManageVO jobKnwldgManageVO)  throws Exception {
        return (Integer)selectOne("jobKnwldgManageDAO.selectJobKnwldgListTotCnt", jobKnwldgManageVO);
    }
    ...
    public JobKnwldgManageVO selectJobKnwldg(JobKnwldgManageVO jobKnwldgManageVO) throws Exception {
        return (JobKnwldgManageVO) selectOne("jobKnwldgManageDAO.selectJobKnwldg", jobKnwldgManageVO);
    }
