...
public class JobIssueManageDAO extends EgovComAbstractDAO {
    ...
    public int selectJobIssueListTotCnt(JobIssueManageVO jobIssueManageVO)  throws Exception {
        return (Integer)selectOne("jobIssueManageDAO.selectJobIssueListTotCnt", jobIssueManageVO);
    }
    ...
    public JobIssueManageVO selectJobIssue(JobIssueManageVO jobIssueManageVO) throws Exception {
        return (JobIssueManageVO) selectOne("jobIssueManageDAO.selectJobIssue", jobIssueManageVO);
    }
