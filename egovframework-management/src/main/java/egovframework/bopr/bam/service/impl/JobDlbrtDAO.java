...
public class JobDlbrtDAO extends EgovComAbstractDAO{
	 /**
	 * 업무심의요청목록을 조회한다.
	...
	public JobDlbrtVO selectJobDlbrt(JobDlbrtVO jobDlbrtVO) throws Exception{
		return (JobDlbrtVO) selectOne("jobDlbrtDAO.selectJobDlbrt", jobDlbrtVO);
	}
	/**
	 * 업무심의요청목록 총 갯수를 조회한다.
	...
	public int selectJobDlbrtListTotCnt(JobDlbrtVO jobDlbrtVO) throws Exception{
		return (Integer)selectOne("jobDlbrtDAO.selectJobDlbrtListTotCnt", jobDlbrtVO);
	}
	/**
	...
	public int selectJobDlbrtPopupListTotCnt(JobDlbrtVO jobDlbrtVO) throws Exception{
		return (Integer)selectOne("jobDlbrtDAO.selectJobDlbrtPopupListTotCnt", jobDlbrtVO);
	}
	/**
	 * 모든 업무심의요청목록을 조회한다.
	 * @param jobDlbrtVO ExecutJobVO
