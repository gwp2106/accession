...
public class BatchDlbrtDAO extends EgovComAbstractDAO{
	 /**
	 * 배치심의요청목록을 조회한다.
	...
	public BatchDlbrtVO selectBatchDlbrt(BatchDlbrtVO batchDlbrtVO) throws Exception{
		return (BatchDlbrtVO) selectOne("batchDlbrtDAO.selectBatchDlbrt", batchDlbrtVO);
	}
	/**
	 * 배치심의첨부파일 내용을 조회한다.
	 * @param BatchDlbrtVO egovBatchDlbrtVO
	...
	public int selectBatchDlbrtListTotCnt(BatchDlbrtVO batchDlbrtVO) throws Exception{
		return (Integer)selectOne("batchDlbrtDAO.selectBatchDlbrtListTotCnt", batchDlbrtVO);
	}
	/**
	 * 배치 목록 총 갯수를 조회한다.
	 * @param batchDlbrtVO BatchDlbrtVO
	...
	public int selectBatchPopupListTotCnt(BatchDlbrtVO batchDlbrtVO) throws Exception{
		return (Integer)selectOne("batchDlbrtDAO.selectBatchPopupListTotCnt", batchDlbrtVO);
	}
	/**
	...
	public int selectBatchDlbrtPopupListTotCnt(BatchDlbrtVO batchDlbrtVO) throws Exception{
		return (Integer)selectOne("batchDlbrtDAO.selectBatchDlbrtPopupListTotCnt", batchDlbrtVO);
	}
	/**
	 * 모든 배치심의요청목록을 조회한다.
	 * @param batchDlbrtVO BatchDlbrtVO
	...
	public int selectBatchBeanTotCnt(BatchDlbrtVO batchDlbrtVO) {
		return (Integer)selectOne("batchDlbrtDAO.selectBatchBeanTotCnt", batchDlbrtVO);
	}
}
