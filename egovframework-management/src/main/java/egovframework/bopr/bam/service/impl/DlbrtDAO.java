 ...
 */
@Repository("dlbrtDAO")
public class DlbrtDAO extends EgovComAbstractDAO{
	 /**
	 * 업무심의목록을 조회한다.
	...
	public DlbrtVO selectJobDlbrt(DlbrtVO dlbrtVO) throws Exception{
		return (DlbrtVO) selectOne("dlbrtDAO.selectJobDlbrt", dlbrtVO);
	}
	@SuppressWarnings("unchecked")
	...
	public int selectJobDlbrtListTotCnt(DlbrtVO dlbrtVO) throws Exception{
		return (Integer)selectOne("dlbrtDAO.selectJobDlbrtListTotCnt", dlbrtVO);
	}
	/**
	 * 모든 업무심의목록을 조회한다.
	 * @param DlbrtVO egovDlbrtVO
	...
	public DlbrtVO selectBatchDlbrt(DlbrtVO dlbrtVO) throws Exception{
		return (DlbrtVO) selectOne("dlbrtDAO.selectBatchDlbrt", dlbrtVO);
	}
	@SuppressWarnings("unchecked")
	...
	public int selectBatchDlbrtListTotCnt(DlbrtVO dlbrtVO) throws Exception{
		return (Integer)selectOne("dlbrtDAO.selectBatchDlbrtListTotCnt", dlbrtVO);
	}
	/**
	 * 모든 배치심의목록을 조회한다.
	 * @param DlbrtVO egovDlbrtVO
