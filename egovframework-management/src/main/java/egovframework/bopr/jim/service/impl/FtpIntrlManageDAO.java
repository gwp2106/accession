...
public class FtpIntrlManageDAO extends EgovComAbstractDAO {
    ...
    public int selectFtpIntrlListTotCnt(FtpIntrlManageVO ftpIntrlManageVO)  throws Exception {
        return (Integer)selectOne("ftpIntrlManageDAO.selectFtpIntrlListTotCnt", ftpIntrlManageVO);
    }
    ...
    public FtpIntrlManageVO selectFtpIntrl(FtpIntrlManageVO ftpIntrlManageVO) throws Exception {
        return (FtpIntrlManageVO) selectOne("ftpIntrlManageDAO.selectFtpIntrl", ftpIntrlManageVO);
    }
//
//    /**
//	 * 사용자목록을 조회한다.
