...
public class MailIntrlManageDAO extends EgovComAbstractDAO {
    ...
    public int selectMailIntrlListTotCnt(MailIntrlManageVO mailIntrlManageVO)  throws Exception {
        return (Integer)selectOne("mailIntrlManageDAO.selectMailIntrlListTotCnt", mailIntrlManageVO);
    }
    ...
    public MailIntrlManageVO selectMailIntrl(MailIntrlManageVO mailIntrlManageVO) throws Exception {
        return (MailIntrlManageVO) selectOne("mailIntrlManageDAO.selectMailIntrl", mailIntrlManageVO);
    }
//
//    /**
//	 * 사용자목록을 조회한다.
