...
public class JobHistDAO extends EgovComAbstractDAO{
	 /**
	 * 작업이력목록을 조회한다.
	...
	public JobHistVO selectJobHist(JobHistVO jobHistVO) throws Exception{
		return (JobHistVO) selectOne("jobHistDAO.selectJobHist", jobHistVO);
	}
	/**
	 * Step실행이력목록을 조회한다.
	 * @param JobHistVO egovJobHistVO
	...
	public JobHistVO selectStepHistMessage(JobHistVO jobHistVO) throws Exception{
		return (JobHistVO) selectOne("jobHistDAO.selectStepHistMessage", jobHistVO);
	}
	/**
	 * 작업이력목록 총 갯수를 조회한다.
	...
	public int selectJobHistListTotCnt(JobHistVO jobHistVO) throws Exception{
		return (Integer)selectOne("jobHistDAO.selectJobHistListTotCnt", jobHistVO);
	}
	/**
	 * 모든 작업이력목록을 조회한다.
	 * @param jobHistVO JobHistVO
