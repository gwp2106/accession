...
public class mainDAO extends EgovComAbstractDAO{
	...
	public MainVO selectSetupInfo(MainVO mainVO) throws Exception {
        return (MainVO) selectOne("mainDAO.selectSetupInfo", mainVO);
    }
	...
	public MainVO selectMenuSetupInfo(MainVO mainVO) throws Exception {
        return (MainVO) selectOne("mainDAO.selectMenuSetupInfo", mainVO);
    }
	...
	public int selectMainListTotCnt(MainVO mainVO) throws Exception{
		return (Integer)selectOne("mainDAO.selectMainListTotCnt", mainVO);
	}
