...
public class LoginPolicyManageDAO extends EgovComAbstractDAO {
    ...
    public int selectLoginPolicyListTotCnt(LoginPolicyManageVO loginPolicyManageVO)  throws Exception {
        return (Integer)selectOne("loginPolicyManageDAO.selectLoginPolicyListTotCnt", loginPolicyManageVO);
    }
    ...
    public LoginPolicyManageVO selectLoginPolicy(LoginPolicyManageVO loginPolicyManageVO) throws Exception {
        return (LoginPolicyManageVO) selectOne("loginPolicyManageDAO.selectLoginPolicy", loginPolicyManageVO);
    }
//
//    /**
//	 * 사용자목록을 조회한다.
